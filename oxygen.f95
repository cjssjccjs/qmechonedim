...
! goes with: C. J. Sweeney, "An Open-Source Fast Integral Transform Program for Quantum-Mechanical Wavefunction Propagation and both
! Eigenvalue and Eigenfunction Determination in one Spatial Dimension" Journal of Numerical Simulations in Physics and Mathema-
! tics 2, 39-58 (2026). Use this article as guidance to understand how the program works and to troubleshoot problems. The recom-
! mended compiler for the source code is GNU Fortran, which can be freely downloaded from the internet along with PlPlot.
!
